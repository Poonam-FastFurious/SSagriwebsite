            ...
            <div className="row">
              <div className="col-lg-12 text-center">
                <div className="tpsection mb-35">
                  <h4 className="tpsection__title">Instruction</h4>
                  <p>
        ...
        <section className="img-box-area grey-bg pt-80 pb-50">
          <div className="container">
            <div className="row">
              <div className="col-lg-12 text-center">
                <div className="tpsection mb-35">
                  <h4 className="tpsection__sub-title">~How does it work? ~</h4>
                  <h4 className="tpsection__title">Just 3 easy steps</h4>
                  <p>
                    The liber tempor cum soluta nobis eleifend option congue
                    doming quod mazim.
                  </p>
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="img-box__wrapper text-center mb-30">
                  ...
                  <div className="img-box__content">
                    <h4 className="img-box__title mb-10">Place three pads</h4>
                    <p>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="img-box__wrapper text-center mb-30">
                  ...
                  <div className="img-box__content">
                    <h4 className="img-box__title mb-10">Pour water</h4>
                    <p>
                      Lorem ipsum dolor sit amet consectetur <br /> adipisicing
                      elit, sed do eiusmod tempor labore <br /> et dolore
                      dignissimos cumque.
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="img-box__wrapper text-center mb-30">
                  ...
                  <div className="img-box__content">
                    <h4 className="img-box__title mb-10">
